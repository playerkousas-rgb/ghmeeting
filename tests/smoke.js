...
G.Store.set('members',[]);
/* 2026-09 負責人：APP 內唔同官方對比（觀感行先）——套包頁可以叫「官方套包」（即官方 PDF 嘅嘢），
   但唔准出現「取代官方／逐項對照」呢類比較字眼 */
ok('⑮ 套包頁唔同官方對比（名可以叫官方套包）',!/逐項對照/.test(pkHtml)&&!/取代官方/.test(pkHtml)&&typeof PK.COVER==='undefined'&&/官方套包/.test(fs.readFileSync(path.join(__dirname,'..','index.html'),'utf8')),
  '比較字眼已全部移除・導航叫官方套包');
